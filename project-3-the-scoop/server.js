...
//Took me far too long. I still do not quite understand a portion of the
//object layout. The "const requestComment = request.body && request.body.comment"
//is not clear to me. I was able to make this work without understanding exactly
//how it was addressing the data. I've noted this down and will study it shortly.
...
function deleteComment(url, request) {
  ...
  if (savedComment) {
    ...
    //database.articles.comments[id] = null;
